...
- Application and dependency services attach to the external network named by
  `DOCKER_NETWORK_NAME`. Start creates it when absent; stop removes it only when
  no container remains connected.
